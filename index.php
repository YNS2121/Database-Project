...
<<<<<<< HEAD
                ...
                if ($sector == "Alan") {
                    ...
                    $sqlFilterUser = "SELECT  meslek_id, meslek_adi, alan_id, alan_adi, kullanici_id, kullanici_ad, kullanici_soyad, kullanici_tanitim, kullanici_email, fotograf_id, fotograf_adresi, video_id, video_adresi, video_zamani FROM fotograflar INNER JOIN (SELECT meslek_id, meslek_adi, alan_id, alan_adi, kullanici_id, kullanici_ad, kullanici_soyad, kullanici_tanitim, kullanici_email,video_adresi, video_zamani, video_id FROM videolar INNER JOIN (SELECT * FROM kullanicilar INNER JOIN (SELECT * FROM kullanici_meslek_detay INNER JOIN (SELECT * FROM meslekler INNER JOIN meslek_alanlar ON meslekler.meslek_id = meslek_alanlar.meslekler_meslek_id HAVING alan_id = '$sector') as filterJob ON filterJob.alan_id = kullanici_meslek_detay.alanlar_alan_id) as user ON user.kullanicilar_kullanici_id = kullanici_id) as videoUser ON videoUser.kullanici_id = videolar.kullanicilar_kullanici_id) as fotograflarUser ON fotograflarUser.kullanici_id = fotograflar.kullanicilar_kullanici_id;";
                } else {
